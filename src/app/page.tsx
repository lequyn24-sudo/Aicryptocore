    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="flex items-center gap-0 mb-6 rounded-xl overflow-hidden border border-glass divide-x divide-glass">
        {platformStats.map((stat) => (
          <div key={stat.label} className="flex-1 px-5 py-3 text-center bg-surface hover:bg-surface-elevated transition-colors">
            <div className="text-xl font-bold leading-none text-[var(--color-text-primary)] mb-0.5"
